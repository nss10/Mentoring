...
public class mentorlogin extends Activity implements OnClickListener {
    ...
    public void onClick(View view) {
        ...
        final String username = this.mentorid.getText().toString().trim();
        ...
        if (username.matches("") || pass.matches("")) {
            ...
            final BackgroundWorker backgroundWorker = new BackgroundWorker(mentorlogin.this);
            final ProgressDialog loading = ProgressDialog.show(mentorlogin.this, "Logging in...", "Please wait", true, true);
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    AlertDialog alertDialog = new Builder(mentorlogin.this).create();
                    if (backgroundWorker.result.matches("1")) {
                        ...
                        editor.commit();
                        startActivity(new Intent(mentorlogin.this, MentorHome.class));
                    }
                    else
                    {
                        loading.dismiss();
